...
sensitivity(factor(classification$scored.class),factor(classification$class),positive="1")

specificity(factor(classification$scored.class),factor(classification$class), positive = "1")
